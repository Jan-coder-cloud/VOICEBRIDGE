...
const tamilSuggestionsMap = {
  // அடிப்படை
  "வணக்கம்": ['நீங்கள் எப்படி இருக்கிறீர்கள்?', 'காலை வணக்கம்!', 'அன்பான நண்பர்!'],
  "தயவு செய்து": ['உதவி செய்க.', 'தண்ணீர் கொடுக்கவும்.', 'தயவு செய்து திறக்கவும்.'],
  ...
  "மன்னிக்கவும்": ['தயவு செய்து மன்னிக்கவும்.', 'மன்னிக்கவும்.', 'மன்னிக்க வேண்டுகிறேன்.'],
  "நல்லது": ['நன்றாக உள்ளது.', 'சரி.', 'நன்றாகச் செய்யப்பட்டது.'],
  "மோசம்": ['இது மோசமானது.', 'நிலை மோசம்.', 'தகவல் மோசமானது.'],
  "சரி": ['சரி.', 'நன்றாக.', 'பரவாயில்லை.'],

  // தேவைகள்
  "தண்ணீர்": ['நான் தண்ணீர் வேண்டும்.', 'ஒரு பாட்டில் தண்ணீர் தரவும்.', 'குடிக்க தண்ணீர் வேண்டும்.'],
  "உணவு": ['நான் உணவு வேண்டும்.', 'சாப்பிட வேண்டும்.', 'சில உணவு கொடுக்கவும்.'],
  "கழிப்பிடம்": ['நான் கழிப்பிடத்திற்கு செல்ல வேண்டும்.', 'கழிப்பிடம் எங்கே?', 'தவிர்க்க முடியாது.'],
  "மருந்து": ['மருந்து தேவை.', 'மருந்து கொடுக்கவும்.', 'நான் மருந்து எடுத்துக் கொள்ள வேண்டும்.'],
  ...
  "உதவி": ['தயவு செய்து உதவி செய்க.', 'உதவி வேண்டும்.', 'நீங்கள் உதவி செய்ய முடியுமா?'],
  ...
  "மருத்துவர்": ['மருத்துவர் தேவை.', 'மருத்துவரை அழைக்கவும்.', 'மருத்துவர் எங்கே?'],
  "ஆசிரியர்": ['ஆசிரியர் தேவை.', 'அவரை அழைக்கவும்.', 'வகுப்பில் ஆசிரியர் உள்ளார்.'],

  // பொதுவான பொருட்கள்
  "தொலைபேசி": ['தொலைபேசியை பயன்படுத்த வேண்டும்.', 'எங்கே தொலைபேசி?', 'தொலைபேசியை தரவும்.'],
  "புத்தகம்": ['நான் புத்தகம் வேண்டும்.', 'புத்தகத்தை எடுக்கவும்.', 'புத்தகம் எங்கே?'],
  ...
  "காற்றாடி": ['காற்றாடி இயக்கவும்.', 'காற்றாடி நிறுத்தவும்.', 'காற்றாடி வேலை செய்கிறது.'],
  "காசி": ['காசி இயக்கவும்.', 'காசி நிறுத்தவும்.', 'இருக்கிறது.'],
  "படுக்கை": ['படுக்கை தயார்.', 'படுக்கையில் தூங்கவும்.', 'படுக்கை சுத்தமாக உள்ளது.'],
  ...
  "ஆம்புலன்ஸ்": ['ஆம்புலன்ஸ் தேவை.', 'விரைவில் அழைக்கவும்.', 'ஆம்புலன்ஸ் வருகிறது.'],
  ...
  "குழப்பம்": ['நான் குழப்பமடைந்தேன்.', 'சிந்திக்க முடியவில்லை.', 'பிரச்சனை உள்ளது.'],

  // இடங்கள்
  "வீடு": ['வீட்டில்.', 'எங்கே வீடு?', 'வீடு பாதுகாப்பாக உள்ளது.'],
  "கழிப்பிடம்": ['நான் கழிப்பிடத்திற்கு செல்ல வேண்டும்.', 'கழிப்பிடம் எங்கே?', 'நான் விரைவில் செல்ல வேண்டும்.'],
  "மருத்துவமனை": ['மருத்துவமனை தேவை.', 'மருத்துவரை அழைக்கவும்.', 'நான் மருத்துவமனை செல்வேன்.'],
  "வகுப்பு": ['வகுப்பில்.', 'வகுப்பு எங்கே?', 'நான் வகுப்பில் உள்ளேன்.'],
  "கன்டீன்": ['கன்டீன்.', 'உணவு வாங்க.', 'நான் கன்டீனுக்கு செல்வேன்.'],
  "நூலகம்": ['நூலகம்.', 'நூலகத்தில் செல்.', 'நான் புத்தகங்களை வாசிக்க விரும்புகிறேன்.'],
};
    ...
    <section className="tile-section">
      {suggestions.length > 0 && (
        <div className="suggestions">
          ...
          <div className="tiles">
            {suggestions.map((s, i) => (
              <button key={i} className="tile suggestion" onClick={() => handleSuggestionClick(s)}>
                {s}
              </button>
            ))}
          </div>
